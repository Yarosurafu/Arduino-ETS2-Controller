...
> **WARNING**: во время теста было замечено, что шина I2C намертво блокирует ардуино. В итоге микроконтроллер не обрабатывает данные. Без дисплея всё работает прекрасно
